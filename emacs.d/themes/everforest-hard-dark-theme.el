...
(everforest-hard-dark-with-color-variables
  (custom-theme-set-faces
   ...
   `(mode-line-active    ((t (:background ,everforest-hard-dark-visual :foreground ,everforest-hard-dark-silver))))
   `(mode-line-buffer-id ((t (:foreground ,everforest-hard-dark-silver :weight bold))))
   `(mode-line-emphasis  ((t (:foreground ,everforest-hard-dark-silver :weight bold))))
